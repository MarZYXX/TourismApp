    ...
    public class PerfilGuiaViewModel : GuiaBaseViewModel
    {
        ...
        private async Task CargarAsync()
        {
            ...
            try
            {
                ...
                if (Perfil == null)
                {
                    await Shell.Current.DisplayAlertAsync("Perfil no disponible", "No fue posible obtener tus datos de guia.", "OK");
                    return;
                }
        ...
        private async Task GuardarAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                await Shell.Current.DisplayAlertAsync("No se pudo actualizar", "Supabase no permitio actualizar el perfil del guia.", "OK");
            }
            finally
            {
                IsBusy = false;
