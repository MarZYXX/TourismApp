...
public partial class DetalleViajeTuristaPage : ContentPage
{
    private readonly DetalleViajeTuristaViewModel _viewModel;

    public DetalleViajeTuristaPage(DetalleViajeTuristaViewModel viewModel)
    {
        InitializeComponent();
